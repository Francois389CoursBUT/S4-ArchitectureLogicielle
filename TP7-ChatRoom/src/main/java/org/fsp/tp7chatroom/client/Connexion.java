 ...
 */
package org.fsp.tp7chatroom.client;
...
import org.fsp.tp7chatroom.serveur.ChatRoom;
...
public class Connexion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ChatRoom charRoom = ChatRoom.getInstance();

        PrintWriter out = response.getWriter();

        try {
            charRoom.connecter(request.getParameter("pseudo"));
        ...
        } catch (PseudoDejaExistantException | PseudoInvalideException e) {
